...
return [
    ...
    'failed_transaction_relay' => 'The transaction hash could not be processed.',
    ...
    'withdrawal_fee_description' => 'Withdrawal fee from :name',
    'deposit_fee_description' => 'Deposit fee from :name',
    'missing_fee_address' => 'Wallet is without fee address.',
];
