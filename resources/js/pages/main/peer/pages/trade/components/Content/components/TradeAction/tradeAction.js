...
const TradeAction = () => {
  ...
  return (
    <Box sx={{ position: 'relative' }}>
      <StyledToggleButton openSidebar={openSidebar} onClick={toggleSidebar}>
        <Iconify icon={openSidebar ? arrowForwardFill : arrowBackFill} width={30} height={30} />
      </StyledToggleButton>
...
const StyledToggleButton = styled(({ openSidebar, ...otherProps }) => <IconButton disableRipple {...otherProps} />)(
  ({ theme, openSidebar }) => ({
