    ...
    <Spin spinning={loading}>
      <StyledCard>
        ...
        <Stack spacing={1} sx={{ p: 3 }}>
          ...
          <Typography sx={{ typography: 'h3' }}>{available ?? <FormattedMessage defaultMessage="----" />}</Typography>

          {pendingReceive && (
            <Typography variant="body2">
              <FormattedMessage defaultMessage="{value} pending credit" values={{ value: pendingReceive }} />
            </Typography>
          )}
        </Stack>
