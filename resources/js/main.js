...
import { fetchCountries, fetchOperatingCountries, fetchSupportedCurrencies, fetchWallets } from 'redux/slices/global';
import ScrollToTop from 'components/ScrollToTop';
import WagmiClient from 'services/Wagmi';
import { WagmiConfig } from 'wagmi';
import './global.css';
import Register from 'installer/Register';

const MainLayout = lazy(() => import(/* webpackChunkName: 'main' */ 'layouts/Main'));

const AuthLayout = lazy(() => import(/* webpackChunkName: 'auth' */ 'layouts/Auth'));
