...
import WalletConnectButton from 'layouts/components/Wallet/WalletConnectButton';
    ...
    <Dashboard>
      ...
      <Header
        ...
        actions={[
          ...
          // <WalletConnectButton key="walletconnect"/>,
          <Account key="account" />
        ]}
      />
      ...
      <Sidebar
        ...
        action={
          auth.can('access_control_panel') ? (
            <Button
              ...
              variant="contained"
              sx={{ boxShadow: 'none', mt: 0.5, borderRadius: '5px' }}
        ...
        extras={
          <DocStyle sx={{ mx: 3, mb: 3, mt: 10 }}>
            ...
            <Typography variant="subtitle1" sx={{ color: 'grey.700' }} gutterBottom>
            ...
            <Button sx={{ borderRadius: '5px' }} target="_blank" href={brand.support_url} variant="contained" fullWidth>
