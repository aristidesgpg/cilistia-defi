...
function Logo({ to, ...otherProps }) {
  const theme = useTheme();
  const getUniqueId = useUniqueId('logo_');
  ...
  return (
    <a href={to}>
      <Container component="img" src={LogoImg} alt="main-logo" {...otherProps} />
    </a>
  );
  // }
  ...
  //         <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 542.83 539.91">
  //           <defs>
  //             <linearGradient
  //               id={getUniqueId('l1')}
  //               x1="-93511.54"
